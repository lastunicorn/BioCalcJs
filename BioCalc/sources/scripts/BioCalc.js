 ...
 */
(function BioCalc($, BioCalcPageData, Configuration, MultiplePersonsBiorhythms, ModalDialogsAutoCloseModule, LineStyle) {
    ...
    function createPageSections() {
        ...
        lu.bioControls.biorhythmModel.MultiplePersonsBiorhythms,
